...
public class MyProperties {
	...
	public static MyProperties Instantiate() throws IOException
	{
		if(mObj==null)
			mObj=new MyProperties(WebAppServer.PROPFILE);
		return mObj;
	}
	public static MyProperties Instantiate(String filename) throws IOException
	{
		if(mObj==null)
	...
	private MyProperties(String filename) throws IOException
	{
