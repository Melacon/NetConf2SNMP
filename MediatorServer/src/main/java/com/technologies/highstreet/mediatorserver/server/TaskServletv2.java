...
public class TaskServletv2 extends HttpServlet {
	...
	private static final Log LOG = LogFactory.getLog(TaskServletv2.class);
	@Override
	...
	private String onTaskVersion(HttpServletRequest req) {
		String bin="java -classpath "+MediatorCoreFiles.MEDIATOR_JAR()+" com.technologies.highstreet.netconf2snmpmediator.server.Netconf2SNMPMediator";
