...
public class NetconfTimeStamp {
	...
	public static String getEventTimeStamp(int year, int month, int day, int hour, int minute, int second, int millisec, String timezone) {
		return LocalDateTime.of(year,month,day,hour,minute,second).format(DateTimeFormatter.ofPattern(dateFormatResultEventTime.toPattern()));
