...
import com.technologies.highstreet.mediatorlib.netconf.server.types.NetconfBoolean;

/**
 * Data conversion between SNMP and Netconf.
 *
 * @author Micha
 *
 */
...
public class NodeEditConfig {
    ...
    {
        public static final String UnsignedNumeric="^[0-9]+$";
        public static final String UnsignedDecimal="^[0-9]+\\.*[0-9]+$";
        public static final String SignedNumeric="^[-]{0,1}[0-9]+$";
        public static final String SignedDecimal="^[-]{0,1}[0-9]+\\.*[0-9]+$";
    }
    ...
    private static Pattern DivideNeg = Pattern.compile("dividen-(\\d+)$");
    ...
    // Construct
    public NodeEditConfig(String xPath, Element e, String oid, String conversion, String readWrite, String def,String validator) {
        if (conversion == null) {
        ...
        this.xPath = xPath;
        this.validator = validator==null?null:Pattern.compile(validator);
    ...
    public NodeEditConfig(String xPath, Element e, String oid) {
        this(xPath, e, oid, e.hasAttribute("conversion") ? e.getAttribute("conversion") : EMPTY,
                ...
                e.hasAttribute("default") ? e.getAttribute("default") : e.getTextContent(),
                        e.hasAttribute("validator")?e.getAttribute("validator"):null
    ...
    public boolean validate(String value)
    {
        ...
        return this.validator.matcher(value).matches();
    }
    // ---------------------------------------------------
    // Functions
    ...
    public String convertValueSnmp2Netconf(String value) {
        ...
        if (res == null) {
            ...
            if (matcher3.matches()) {
                try {
                    res = String.valueOf(Math.round(_floatintval(value) / Integer.valueOf(matcher3.group(1))));
        ...
        if (res == null) {
            Matcher matcher3 = DivideNeg.matcher(conversion);
            if (matcher3.matches()) {
                try {
                    res = String.valueOf(Math.round(-1*_floatintval(value) / Integer.valueOf(matcher3.group(1))));
                } catch (NumberFormatException e) {
                    res = null;
                }
            }
    ...
    private static float _floatintval(String s)
    {
        return Float.valueOf(Integer.valueOf(s));
    }
    /**
    ...
    public Variable convertValueNetconf2SnmpString(String value) {
        ...
        if (res == null) {
            matcher = DivideNeg.matcher(conversion);
            if (matcher.matches()) {
                try {
                    res = new Integer32(-1*Integer.valueOf(value) * Integer.valueOf(matcher.group(1)));
                } catch (NumberFormatException e) {
                    res = null;
                }
            }
    ...
    public String getValidatorString() {
        return this.validator==null?"":this.validator.pattern();
    }
