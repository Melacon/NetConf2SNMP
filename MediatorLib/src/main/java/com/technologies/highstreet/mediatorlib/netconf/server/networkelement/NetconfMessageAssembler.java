...
import com.technologies.highstreet.mediatorlib.netconf.server.types.NetconfTimeStamp;
...
/**
 * Create XML messages according to YANG specification for ONF Core model related communication.
 * Using ONF Core model in XML format
 * Device independent
 * structural knowledge of messages, analyse, create, modify
 *
 * @author herbert
 */
