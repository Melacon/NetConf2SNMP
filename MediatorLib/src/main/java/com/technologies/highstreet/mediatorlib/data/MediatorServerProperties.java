...
public class MediatorServerProperties {
	...
	private static final String JSONKEY_LOGLEVEL = "loglevel";
	private static final String JSONKEY_LOGFILE = "logfile";
	private static final String JSONKEY_MED_LOGLEVEL = "mediator-loglevel";
	private static final String JSONKEY_MED_DEVICEPING_TIMEOUT = "mediator-devicepingtimeout";
	private static final String JSONKEY_MED_SNMPLATENCY = "mediator-snmplatency";
	private static final String JSONKEY_MED_MEMORY = "mediator-memory";

	public static boolean exists()
	{
		return new File(PROPFILE).exists();
	}
